...
class MatrixOrgClient {
    ...
    */
    function __construct(modX & $modx, array $options = array()) {
        ...
        $corePath = $this->getOption('core_path', $options, $this->modx->getOption('core_path') . 'components/matrixorgclient/');
        $assetsPath = $this->getOption('assets_path', $options, $this->modx->getOption('assets_path') . 'components/matrixorgclient/');
        $assetsUrl = $this->getOption('assets_url', $options, $this->modx->getOption('assets_url') . 'components/matrixorgclient/');
        ...
        include $corePath . 'model/api/API.php';
